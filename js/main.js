...
app.sideMenu = {
  init: function() {
    return window.addEventListener('load', this.marcarItemMenuActivo);
  },
  marcarItemMenuActivo: function() {
    var href, i, item, itemsMenu, len, results, urlActual;
    urlActual = window.location.pathname;
    console.log("URL Actual: ", urlActual);
    itemsMenu = document.querySelectorAll('.nav--menu ul li a');
    console.log("Items del Menú Encontrados: ", itemsMenu.length);
    results = [];
    for (i = 0, len = itemsMenu.length; i < len; i++) {
      item = itemsMenu[i];
      href = item.getAttribute('href');
      console.log("Comparando: ", href, " con ", urlActual);
      if (urlActual.endsWith(href) || (href === 'index.html' && urlActual === '/')) {
        item.classList.add('a--active');
        results.push(console.log("Clase Añadida a: ", item));
      } else {
        results.push(void 0);
      }
    }
